...
portfolio_5 = Portfolio.create(slug: "Koii")
portfolio_6 = Portfolio.create(slug: "Moey")
...
[
  ...
  # 1.0525
  {
    date: "2018-01-15 22:02:25",
    symbol: "ETH/THB",
    status: "WITHDRAW",
    price: 40823.92933816478,
    volumn: 1.0525,
    commission: 102.059823
  },
  {
    date: "2018-01-23 09:37:20",
    symbol: "XZC/THB",
    status: "BUY",
    price: 0,
    volumn: 0.08001985,
...
[
  ...
  Transaction.create(hash.merge({ portfolio_id: portfolio_5.id }))
end

# Port 6
[
  {
    date: "2018-03-15 19:12:16",
    symbol: "OMG/THB",
    status: "BUY",
    price: 360,
    volumn: 13.85693750,
  ...
  Transaction.create(hash.merge({ portfolio_id: portfolio_6.id }))
end
